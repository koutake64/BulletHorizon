...
public class OfflinePlayer : MonoBehaviour
{
	...
	[SerializeField, Header("îΩìÆ")] float handou;

	[SerializeField, Tooltip("èäóLíeñÚ")] int[] ammunition;
	[SerializeField, Tooltip("ç≈ëÂèäóLíeñÚ")] int[] maxAmmunition;
	[SerializeField, Tooltip("É}ÉKÉWÉìì‡íeñÚ")] int[] ammoClip;
	[SerializeField, Tooltip("É}ÉKÉWÉìÇ…ì¸ÇÈç≈ëÂíeñÚêî")] int[] maxAmmoClip;
